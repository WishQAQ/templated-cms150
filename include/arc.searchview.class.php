...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<span class=\"pages\">".$this->TotalResult."条</span>\r\n";
        ...
        {
            $plist.="<input type='text' name='PageNo' style='width:28px;height:14px' value='".$this->PageNo."' /></td>\r\n";
            $plist.="<input type='submit' name='plistgo' value='GO' style='width:30px;height:22px;font-size:9pt' /></td>\r\n";
        }
        $plist .= "</form>\r\n";
        return $plist;
    }
