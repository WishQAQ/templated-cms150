...
//百度输入
	...
	if($etype==Member || $etype==MemberLit) $ejs="1";
		...
		$code = <<<EOT
	<SCRIPT type=text/javascript charset="gb2312" src="/include/ueditor/editor_config$ejs.js"></SCRIPT>
	<SCRIPT type=text/javascript charset="gb2312" src="/include/ueditor/editor_all_min.js"></SCRIPT> 
<SCRIPT id="$fname" type=text/plain name="$fname">$fvalue</SCRIPT>
<SCRIPT type=text/javascript>
var editor = UE.getEditor("$fname");
</SCRIPT> 
EOT;
