...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<span class=\"pages\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span class=\"pages\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<span class=\"pages\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span>\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"prev-page\"><a href='".$purl."PageNo=$prepagenum'>上一页</a></li>";
            $indexpage="";			
        }
        else
        {
            $indexpage="<li class=\"prev-page\"></li>";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li class=\"next-page\"><a href='".$purl."PageNo=$nextpagenum>下一页</a></li>\r\n";
            $endpage="";			
        }
        else
        {
