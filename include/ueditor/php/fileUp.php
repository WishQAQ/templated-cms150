<?php
    ...
    $config = array(
        ...
        "allowFiles" => array( ".rar" , ".doc" , ".docx" , ".zip" , ".pdf" , ".txt" , ".swf" , ".wmv" , ".xls" , ".chm", ".xlsx") , //文件允许格式
	...
	if(!empty($arcid))
		{
		$inquery = "INSERT INTO `#@__uploads`(arcid,title,url,mediatype,width,height,playtime,filesize,uptime,mid)
	VALUES ('$arcid','$filename','$activepath','1','$imgwidthValue','$imgheightValue','0','{$imgsize}','{$nowtme}','".$cuserLogin->getUserID()."'); ";
		}
