...
//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:URLS                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,imageManagerPath:URLS                                    //图片修正地址，同imagePath
       ...
       //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        ,toolbars:[["FullScreen","Undo","Redo","InsertUnorderedList","InsertOrderedList","Preview","InsertImage","Emotion","Horizontal","RemoveFormat","AutoTypeSet","Bold","Underline"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'fullscreen':'','undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','preview':'','insertimage':'','emotion':'','horizontal':'','removeformat':'','autotypeset':'','bold':'','underline':''}
