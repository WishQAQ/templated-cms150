...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"prev-page\"><a href='".str_replace("{page}", $prepagenum, $tnamerule)."'>上一页</a></li>";
            $indexpage="";
        }
        else
        {
        ...
        {
            $nextpage.="<li class=\"next-page\"><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a></li>\r\n";
            $endpage="";
        }
        else
        {
