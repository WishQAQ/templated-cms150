...
<div class='decmt-box2'>
		<li class="comment even thread-even depth-1"><div class="c-avatar"><img alt='' src='/gong/images/default.png' class='avatar avatar-36 photo' height='36' width='36' /></div><div class="c-main"><p><?php echo ubb($msg); ?></p>
<div class="c-meta"><span class="c-author"><?php echo $username; ?></span><?php echo GetDateMk($dtime); ?> </div></div></li><!-- #comment-## -->
