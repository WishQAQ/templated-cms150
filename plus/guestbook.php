...
else if($action=='save')
{
	...
	if($needCheck==1)
	{
		...
		$msg = "
		<font><b>你已成功发送留言！</b></font> &nbsp; &nbsp;<a href='guestbook.php'><u>点击返回&gt;&gt;</u></a>";
  	$wintitle = "一花一叶 - 留言发布成功提示";
		$wecome_info = "留言发布成功：";
		$win = new OxWindow();
		$win->Init("","js/blank.js","post");
		$win->AddTitle("提示：");
		$win->AddMsgItem("<div style='padding:20px;line-height:30px;font-size:12px'>$msg</div>");
